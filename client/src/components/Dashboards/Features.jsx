...
const Features = (props) => {
    ...
    return (
        <div className="mt-0.5">
            ...
            <div className="flex flex-wrap xl:flex-nowrap min-w-00">
                <div>
                    {foodFeatures.filter(feat => feat.location_id === props.id).map((feat) => {
                        return (
                            <div className="border-b border-gray-600 max-w-400 p-4" style={{ backgroundImage: `linear-gradient(to top, #191919, #2f2f2f` }}>
                                ...
                                <p className="font-semibold text-gray-200 text-lg p-2">{feat.title}</p>
                                <p className="h-20 text-gray-400 px-2 pb-2">{feat.ingredients}</p>
