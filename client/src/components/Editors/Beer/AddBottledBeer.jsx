...
const AddBottledBeer = () => {
    ...
    return (
        <div className="flex flex-col text-gray-200 md:w-350 w-full md:mx-0 mx-1">
            <ContainerHeader title="Add Beer to Bottled Catalog" />
            <div
                className="text-gray-200 border-b border-gray-600 rounded-b-xl pt-2 pb-1"
