            ...
            <div className="flex flex-col justify-center dark:text-gray-200 text-slate-900">
                ...
                <div className="flex justify-center mt-10">
                    <form className="flex flex-col" onSubmit={handleSubmit}>
                        <h1 className="flex justify-center text-xl m-4">Login to Your Account</h1>
                        <input
                            type="text"
                            placeholder="Email"
                            name="email"
                        ...
                        <input
                            ...
                            value={data.password}
                            required
                            className="text-slate-900 border border-gray-800 rounded-lg m-2 p-2"
                        />
                ...
                <div className="flex flex-col mt-10 mx-auto">
                        <h1 className="text-xl m-2 p-2">New Here?</h1>
                        <Link to='/signup'>
                            <button type="button" className="text-gray-200 border border-gray-400 hover:shadow-2xl rounded-lg bg-slate-900 p-2 w-full">
                                Sign Up
                            </button>
                        </Link>
