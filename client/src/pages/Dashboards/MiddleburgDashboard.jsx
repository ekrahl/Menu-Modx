  ...
  return (
    <>
      <div className="flex justify-center">
        <div className="flex justify-center bg-middleburg bg-cover bg-center rounded-xl w-full mx-3 mt-16 md:mt-2 py-16 md:py-28 md:max-w-1175" >
          <p className="flex justify-center font-semibold text-4xl md:text-6xl text-gray-200 bg-half-transparent rounded-xl p-2">Middleburg</p>
        </div>
      </div>
