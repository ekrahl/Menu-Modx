    ...
    <div className="mt-24 lg:mt-6">
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center mt-6 gap-1">
        <div className="flex flex-col items-center">
          <CurrentMenu menu={menus[0].featureMenu} />
          ...
          <div className="w-350 mt-6">
            ...
            <div
              ...
              <div className="flex justify-center p-4 gap-6">
                <img className="h-28" src={menus[0].featureMenu} alt="" />
        ...
        <div className="flex flex-wrap justify-center">
          <div className="">
            ...
            <div className="w-816 h-1056 relative z-1" ref={ref} id="leesburgFeatureMenu">
