...
const MiddleburgHappyHourEditor = () => {
  ...
  const onButtonClick = useCallback(() => {
    ...
    toPng(ref.current, { cacheBust: true, pixelRatio: 10, width: 384, height: 576 })
      .then((dataUrl) => {
        ...
        link.download = "happy_hour_menu_middleburg.png"
        link.href = dataUrl
        link.click()
      })
      .catch((err) => {
          ...
          <div className="flex flex-wrap justify-center">
            <div className="">
              ...
              <div className="w-384 h-576 relative z-1" ref={ref} id="menu">
                <img src={images.happy_hour_menu_middleburg_template} alt="happy hour menu template" className="absolute z-2" />
                <div className="flex flex-col justify-between text-center pt-9 h-full pb-2 max-h-576"
                  ...
                  <div className="flex justify-center relative w-275 mx-auto mt-2">
                    <div className="gap-1" style={{ fontWeight: '500', fontSize: '10px', lineHeight: '12px' }}>
                      ...
                      <p className="flex items-center justify-center gap-1" >
                        <GiAnchor size="0.5rem" />{rules[1].rule}<GiAnchor size="0.5rem" className="rotate-90" /></p>
                    </div>
                  </div>
...
export default MiddleburgHappyHourEditor