...
var node = document.getElementById('middleburgOysterMenu');
    ...
    const onButtonClick = useCallback(() => {
        ...
        toPng(ref.current, { cacheBust: true, pixelRatio: 10, width: 384, height: 576 })
            .then((dataUrl) => {
                ...
                link.download = "middleburg-oyster-menu.png"
                link.href = dataUrl
                link.click()
            })
            .catch((err) => {
    ...
    return (
        <>
            <div className="mt-24 lg:mt-6">
                <p className="text-center font-semibold text-4xl dark:text-gray-200 py-8">Oyster Editor</p>
                <div className="flex flex-wrap lg:flex-nowrap justify-center mt-6 gap-1">
                <CurrentMenu menu={images.oyster_menu_middleburg} />
                    <div className="flex flex-wrap justify-center">
                        <div className="">
                            ...
                            <div className="w-384 h-576 relative z-1" ref={ref} id="middleburgOysterMenu">
                    ...
                    <div className="w-350">
                        ...
                        <div className="text-gray-200 border-b border-gray-600 rounded-b-xl p-2" style={{ backgroundImage: `linear-gradient(to top, #191919, #2f2f2f` }}>
                            <div className="flex justify-center p-4 gap-6">
                                <img className="h-28" src={images.oyster_menu_tent} alt=""/>
