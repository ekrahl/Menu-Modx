...
var node = document.getElementById('nomaFeatureMenu');
...
const NomaFeatureEditor = () => {
  ...
  const onButtonClick = useCallback(() => {
    ...
    toPng(ref.current, { cacheBust: true, pixelRatio: 10 })
      .then((dataUrl) => {
        ...
        link.download = "noma-feature-menu.png"
        link.href = dataUrl
        link.click()
      })
      .catch((err) => {
  ...
  return (
    <div className="mt-24 lg:mt-6">
      <div className="text-center font-semibold text-3xl mb-10">
      ...
      </div>      <div className="flex flex-wrap lg:flex-nowrap justify-center mt-6 gap-1">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="">
            ...
            <div className="w-816 h-1056 relative z-1" ref={ref} id="nomaFeatureMenu">
...
export default NomaFeatureEditor