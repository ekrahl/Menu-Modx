  ...
  const onButtonClick = useCallback(() => {
    ...
    toPng(ref.current, { cacheBust: true, pixelRatio: 10, width: 384, height: 576 })
      .then((dataUrl) => {
        ...
        link.download = "happy_hour_menu_potomac.png"
        link.href = dataUrl
        link.click()
      })
      .catch((err) => {
          ...
          <div className="flex flex-wrap justify-center">
            <div>
              ...
              <div className="w-384 h-576 relative z-1" ref={ref} id="menu">
                <img src={images.happy_hour_menu_potomac_template} alt="happy hour menu template" className="absolute z-2" />
...
export default PotomacHappyHourEditor