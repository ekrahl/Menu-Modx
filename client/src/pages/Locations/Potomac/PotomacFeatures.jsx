                ...
                <div className="mx-3">
                    ...
                    <div className="flex flex-wrap lg:flex-nowrap mt-6">
                        <div className="lg:max-w-500 m-1">
                            ...
                            <img className="border-b border-gray-600" src={images.menu_features_potomac} alt="Leesburg Features Menu" title="Leesburg Features Menu" />
                            ...
                            <div className="mt-2">
                                ...
                                <div
                                    ...
                                    <div className="flex justify-center p-4 gap-6">
                                        <img className="h-28" src={images.menu_features_potomac} alt="Leesburg features" />
