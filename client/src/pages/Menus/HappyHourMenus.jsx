    ...
    <>
      <div className="flex justify-center">
        <div className="mt-24 mx-3 lg:mt-10 2xl:mx-8 max-w-1200">
          <div className="flex justify-center bg-hh bg-cover bg-center rounded-xl py-20 2xl:p-32" >
            <p className="font-semibold text-4xl 2xl:text-6xl text-gray-200 bg-black bg-opacity-50 rounded-xl p-2">HAPPY HOUR</p>
          </div>
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center gap-1 mt-1">
            ...
            <div className="">
              ...
              <img className="border-b border-gray-600" src={images.happyhour_menu_tent} alt="" />
              <div 
